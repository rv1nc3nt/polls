...
| Administrateur de scrutin | Modifie la configuration tant que le scrutin est à l'état de projet ; annonce, ouvre, clôt et publie le scrutin ; génère et révoque le lien de partage de l'aperçu du projet ; statue sur les inscriptions signalées pour examen manuel. |
...
**R-2.4** L'interface d'administration est développée pour cet usage. Elle est employée par des conseillers municipaux et des agents de la mairie, relève de la règle R-14.1 au même titre que le reste du site, et ne doit pas présenter des actions destructrices à côté des actions courantes. Toute action définitive sur un scrutin — annonce, ouverture, clôture, publication, retrait, prorogation de la date de clôture, suppression d'un scrutin d'essai, enregistrement du rapprochement des bulletins papier — n'est exécutée qu'après une confirmation explicite, donnée sur une page qui en rappelle les conséquences.
...
**R-3.2** Les changements d'état sont strictement ordonnés : `projet → annoncé → ouvert → clos → publié` ; un scrutin ne peut s'ouvrir sans avoir d'abord été annoncé (R-3.10). Depuis les états `annoncé`, `ouvert`, `clos` ou `publié`, et depuis eux seuls, un scrutin peut en outre être retiré (R-3.11), vers un état `retiré` qui met fin à son cycle de vie. Aucune transition n'est réversible.
...
**R-3.4** Exceptions à la règle R-3.3, au nombre de trois. D'une part, la date de clôture peut être prorogée pendant que le scrutin est ouvert. La prorogation est consignée au journal d'audit avec l'identité de l'opérateur, l'horodatage et un motif obligatoire, et elle est affichée sur la page publique du scrutin. D'autre part, lorsque l'administrateur du scrutin ouvre à la main un scrutin annoncé avant sa date d'ouverture, la date d'ouverture est ramenée à l'instant de l'ouverture : le scrutin est alors ouvert au vote et à l'inscription, et listé comme tel sur le site public, dès cet instant et non à la date initialement prévue. Cette date ne peut jamais être avancée autrement, ni reculée, et l'ancienne comme la nouvelle date figurent au journal d'audit avec l'ouverture. L'ouverture programmée à la date prévue ne modifie rien. Enfin, l'administrateur du scrutin peut clore à la main un scrutin ouvert avant sa date de clôture : la date de clôture est alors ramenée à l'instant de la clôture, et aucun bulletin ni aucune inscription n'est plus accepté à compter de cet instant. La clôture anticipée exige un motif obligatoire ; elle est consignée au journal d'audit avec l'identité de l'opérateur, l'horodatage, l'ancienne et la nouvelle date, et elle est affichée sur la page publique du scrutin.
...
**R-3.7** Un scrutin marqué comme scrutin d'essai est exclu des listes publiques et de toute statistique, et son résultat ne figure sur aucune page publique. Cette qualité est fixée à la création et n'est pas modifiable. Un scrutin d'essai suit le cycle de vie d'un scrutin ordinaire et peut être essayé de bout en bout — page du scrutin, inscription, vote et, une fois publié, résultat — par quiconque détient le lien impossible à deviner que l'administrateur du scrutin génère à cet effet (règle R-3.10 bis) ; les bulletins qui y sont déposés ne comptent pour rien. L'administrateur du scrutin peut le supprimer à tout état : le scrutin, ses propositions, ses bulletins, ses inscriptions et sa copie figée de la liste électorale sont alors effacés. Cette suppression est, pour un scrutin d'essai et pour lui seul, une exception à la règle R-7.2 (aucun bulletin n'est jamais matériellement supprimé) et à la règle R-12.3 (aucun rôle ne supprime une inscription) ; le journal d'audit n'est jamais touché, conserve tous les événements du scrutin et enregistre la suppression.
...
**R-3.10** Un scrutin encore à l'état de projet doit être annoncé avant de pouvoir s'ouvrir (R-3.2) : l'administrateur du scrutin le fait alors passer à l'état `annoncé`, visible sur le site public avant son ouverture. Les propositions et le calendrier y sont montrés, aucune inscription ni aucun vote n'y est proposé, et la page indique expressément que le scrutin n'est pas encore ouvert. Le passage à cet état fige la configuration au même titre que le passage à l'état ouvert (R-3.3) : la page publique ne peut donc pas changer sous les yeux de qui la consulte. L'annonce est refusée si la configuration comporte une traduction manquante dans une langue activée (règle R-14.3), comme pour l'ouverture : la page publique ne saurait figer, ni montrer, une configuration incomplète. Elle est également refusée si la date d'ouverture est déjà atteinte : un scrutin annoncé après l'heure prévue pour son ouverture figerait un aperçu public pour l'ouvrir aussitôt derrière, ce qui priverait cette étape de la relecture qu'elle est censée offrir ; l'administrateur doit alors d'abord reporter la date d'ouverture, ce que R-3.3 lui permet librement tant que le scrutin est encore à l'état de projet. Un scrutin encore à l'état de projet n'apparaît sur aucune page publique.

**R-3.10 bis** Indépendamment de l'annonce, l'administrateur du scrutin peut générer un lien impossible à deviner qui permet à quiconque le détient de consulter l'aperçu d'un scrutin encore à l'état de projet, exactement tel que le montre l'aperçu interne de l'administrateur — propositions, calendrier, aucune inscription ni aucun vote proposé. À la différence de l'annonce, ce lien ne fige pas la configuration : la page peut changer d'une consultation à l'autre, tout comme le projet lui-même peut encore changer, et la page le dit expressément. L'administrateur peut régénérer ce lien à tout moment, ce qui invalide aussitôt le précédent, ou le révoquer purement et simplement ; ni l'une ni l'autre de ces actions n'exige de motif. Le lien n'est jamais répertorié ni accessible depuis le site public, fonctionne de la même façon que le scrutin soit ou non marqué comme scrutin d'essai (règle R-3.7) tant que celui-ci est à l'état de projet, puis redirige simplement vers la page publique réelle du scrutin dès qu'il quitte cet état, plutôt que d'échouer. Un scrutin d'essai fait exception, puisqu'il n'a aucune page publique vers laquelle rediriger : son lien reste valable à tous les états, sauf révocation ou régénération, et donne alors accès à la page du scrutin, à l'inscription et au vote, dans les conditions d'un scrutin ordinaire (règle R-3.7).

**R-3.11** À l'état `annoncé`, `ouvert`, `clos` ou `publié`, l'administrateur du scrutin peut retirer le scrutin, pour un motif obligatoire consigné au journal d'audit (règle R-12.2). Le retrait est un changement d'état, vers l'état `retiré` (règle R-3.2) ; il est irréversible, comme tout changement d'état. Dès le retrait, le scrutin ne figure plus sur aucune page publique, sous quelque forme que ce soit — propositions, calendrier, participation en cours, résultat déjà publié le cas échéant (règle R-11.2) — et la page qui portait son adresse indique seulement qu'il a été retiré, sans en révéler le contenu. Le retrait n'affecte ni les bulletins ni le journal d'audit ; son effet sur la conservation des données d'identité est celui de la règle R-13.3. Il ne saurait effacer une copie du résultat déjà obtenue par un tiers avant qu'il n'intervienne.

**R-3.12** Un scrutin peut disposer d'une petite bibliothèque d'images, déposées une fois pour toutes au niveau du scrutin, chacune identifiée par un repère court affiché à côté d'elle à l'attention de l'opérateur. La description du scrutin lui-même (règle R-3.1) et, en complément de son libellé (règle R-3.1), la description étendue de chaque option sont un texte mis en forme (titres, listes, emphase, liens, et une image tirée de cette bibliothèque par son repère), pouvant comporter l'insertion de vidéos issues de YouTube — à l'exclusion de tout autre contenu incorporé de provenance extérieure. La description étendue d'une option est facultative et sa traduction, à la différence de celle du libellé — ou de celle de la description du scrutin lui-même —, ne fait jamais obstacle à l'annonce ni à l'ouverture du scrutin (règles R-3.10, R-14.3) : une langue activée dépourvue de description étendue affiche celle de la langue par défaut du scrutin, ou n'affiche rien si celle-ci est elle-même absente. Les descriptions comme la bibliothèque d'images sont figées avec le reste de la configuration au même moment que le libellé (règle R-3.3), et n'entrent pour rien ni dans le dépouillement, ni dans l'empreinte de clôture (règle R-10.7).
...
**R-13.3** Durées de conservation : les données d'identité (enregistrements d'inscription, copie figée de la liste électorale, association des bulletins papier aux électeurs) sont supprimées à l'expiration d'un délai de deux mois courant à compter de la clôture du scrutin, ou de son retrait (règle R-3.11) lorsque celui-ci intervient avant la clôture, et les rubriques déclarées au titre de la règle R-12.4 sont effacées du journal d'audit au même terme. Le point de départ est la clôture, ou à défaut le retrait, et non la publication : un scrutin clos qui n'est jamais publié — départage physique non tranché, résultat abandonné — conserverait sinon ces données indéfiniment, de même qu'un scrutin retiré avant d'être clos n'aurait sinon aucun point de départ. Les bulletins anonymisés, le résultat publié s'il existe et le journal lui-même sont conservés au-delà.
