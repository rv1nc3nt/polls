...
**R-3.12** Chaque option d'un scrutin peut recevoir, en complément de son libellé (règle R-3.1), une description étendue : un texte mis en forme (titres, listes, emphase, liens), pouvant comporter des images hébergées par la plate-forme elle-même et l'insertion de vidéos issues de YouTube — à l'exclusion de tout autre contenu incorporé de provenance extérieure. Cette description est facultative et sa traduction, à la différence de celle du libellé, ne fait jamais obstacle à l'annonce ni à l'ouverture du scrutin (règles R-3.10, R-14.3) : une langue activée dépourvue de description étendue affiche celle de la langue par défaut du scrutin, ou n'affiche rien si celle-ci est elle-même absente. Elle est figée avec le reste de la configuration au même moment que le libellé (règle R-3.3), et n'entre pour rien ni dans le dépouillement, ni dans l'empreinte de clôture (règle R-10.7).
