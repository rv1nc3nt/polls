...
class Action(models.TextChoices):
    ...
    # POLL_CONFIG_CHANGED, but naming which image changed needs its own code
    # rather than the generic "changed" field list that one carries.
    POLL_IMAGE_ADDED = "poll_image_added", _("image du scrutin ajoutée")
    ...
    RECONCILIATION_RECORDED = "reconciliation_recorded", _("rapprochement papier enregistré")
    ...
    COMMUNE_SETTINGS_CHANGED = "commune_settings_changed", _("paramètres de la commune modifiés")
    COMMUNE_BRANDING_CHANGED = "commune_branding_changed", _("image de la commune ajoutée")
    COMMUNE_BRANDING_REMOVED = "commune_branding_removed", _("image de la commune supprimée")
