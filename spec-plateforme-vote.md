...
| `preview_token` | text, blank by default | R-3.10 bis's share link; generated/regenerated/revoked only while `draft`; a lifecycle/access field, deliberately outside `FROZEN_CONFIG_FIELDS` |
